  ...
  const updateAreaAlert = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Hectares", onPress: () => storePreferences({...measurementPreferences, area: 'hectares', areaShort: 'ha'}) },
        ...
        <View className=" justify-between flex-wrap" style={{gapY: 8}}>
          ...
          <View className="flex-row items-center " style={{gap: 8}}>
            <Text className=" text-gray-9" style={regular}>
              <Text className=" text-black" style={[regular, {fontSize: 20}]}>
                { polygonArea 
          ...
          <View>
            <Text className="text-base text-gray-9" style={regular}>
              <Text className="text-xl text-black" style={[regular, {fontSize: 20}]}>
                { polygonDistance
