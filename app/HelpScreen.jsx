    ...
    <SafeAreaView className="flex-1">
      <ScrollView className="flex-1 p-4" contentContainerStyle={{gap: 32, paddingBottom: 32}}>
        <View style={{gap: 8}}>
          ...
          <Text style={[regular, {lineHeight: 28}]}>2. "Start Measuring" in Auto Measure or start adding markers in Manual Measure or Tap to Measure.</Text>
          <Text style={[regular, {lineHeight: 28}]}>3. Adjust display and measurement settings with the gear icon in the upper right of the screen.</Text>
          <Text style={[regular, {lineHeight: 28}]}>4. Make changes with "Delete Options" to either select individual markers to delete or delete all markers.</Text>
          ...
          <Text style={[regular, {lineHeight: 28}]}>7. Click on a saved measurement to view the map, or delete the measurement with the trash icon.</Text>
        </View>
